...
class ventanacliente2 extends JFrame {  //La clase hereda de JFrame para poder crear cuadros(ventanas)
    public ventanacliente2() { //Constructor
...
class Lamina2 extends JPanel implements Runnable{
    ...
    private class ObtenerTexto implements ActionListener{
        ...
        public void actionPerformed(ActionEvent e) {
           ...
           try {
            Socket Cliente2 = new Socket ("192.168.0.14" , 9090); //coloca como parametros direccion ip y puerto
            ...
            ObjectOutputStream paquete_datos = new ObjectOutputStream(Cliente2.getOutputStream());
    ...
    public void run() { //Aplicacion debe estar a al escucha de Cliente2
        try{
            ...
            while(true){
                cliente =servidor.accept();public class Cliente {
